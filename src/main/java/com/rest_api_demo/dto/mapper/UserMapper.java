...
import com.rest_api_demo.dto.mapper.core.AbstractTripleMapper;
...
@Component
public class UserMapper extends AbstractTripleMapper<UserEntity, UserDto, UserCompact> {


    public UserMapper(ProductRepository productRepository) {
    ...
    protected void mapSpecificFields(final UserEntity source, final UserDto destination) {
        destination.setProducts(Optional.ofNullable(source.getProducts()).orElse(Collections.emptyList())
                        .stream()
